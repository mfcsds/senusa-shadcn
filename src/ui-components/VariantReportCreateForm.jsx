...
import { createVariantReport } from "../graphql/mutations";
...
export default function VariantReportCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setMedical_history(initialValues.medical_history);
    setCurrent_diagnosis(initialValues.current_diagnosis);
    setInstitutionID(initialValues.institutionID);
    setCreateAt(initialValues.createAt);
    setPhenotype(initialValues.phenotype);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createVariantReport.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "VariantReportCreateForm")}
      {...rest}
    >
      <TextField
        label="Status"
