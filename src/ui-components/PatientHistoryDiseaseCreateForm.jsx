...
import { createPatientHistoryDisease } from "../graphql/mutations";
const client = generateClient();
export default function PatientHistoryDiseaseCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createPatientHistoryDisease.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "PatientHistoryDiseaseCreateForm")}
      {...rest}
    >
      <TextField
        label="Id patient"
