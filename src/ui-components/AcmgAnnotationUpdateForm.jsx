...
import { getAcmgAnnotation } from "../graphql/queries";
import { updateAcmgAnnotation } from "../graphql/mutations";
const client = generateClient();
export default function AcmgAnnotationUpdateForm(props) {
  const {
    id: idProp,
    acmgAnnotation: acmgAnnotationModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = acmgAnnotationRecord
      ? { ...initialValues, ...acmgAnnotationRecord }
      : initialValues;
    setId_variant(cleanValues.id_variant);
    setPVS1(cleanValues.PVS1);
    setPS1(cleanValues.PS1);
    setPS2(cleanValues.PS2);
    setPS3(cleanValues.PS3);
    setPS4(cleanValues.PS4);
    setPP1_Strong(cleanValues.PP1_Strong);
    setPM1(cleanValues.PM1);
    setPM2(cleanValues.PM2);
    setPM3(cleanValues.PM3);
    setPM4(cleanValues.PM4);
    setPM5(cleanValues.PM5);
    setPM6(cleanValues.PM6);
    setPP1_Moderate(cleanValues.PP1_Moderate);
    setPP1_Cosegregation(cleanValues.PP1_Cosegregation);
    setPP2(cleanValues.PP2);
    setPP3(cleanValues.PP3);
    setPP4(cleanValues.PP4);
    setPP5(cleanValues.PP5);
    setBP1(cleanValues.BP1);
    setBP2(cleanValues.BP2);
    setBP3(cleanValues.BP3);
    setBP4(cleanValues.BP4);
    setBP5(cleanValues.BP5);
    setBP6(cleanValues.BP6);
    setBP7(cleanValues.BP7);
    setBS1(cleanValues.BS1);
    setBS2(cleanValues.BS2);
    setBS3(cleanValues.BS3);
    setBS4(cleanValues.BS4);
    setBA1(cleanValues.BA1);
    setAcmg_class(cleanValues.acmg_class);
    setErrors({});
  };
  const [acmgAnnotationRecord, setAcmgAnnotationRecord] = React.useState(
    acmgAnnotationModelProp
  );
  React.useEffect(() => {
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getAcmgAnnotation.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getAcmgAnnotation
        : acmgAnnotationModelProp;
      setAcmgAnnotationRecord(record);
    };
    queryData();
  }, [idProp, acmgAnnotationModelProp]);
  React.useEffect(resetStateValues, [acmgAnnotationRecord]);
  const validations = {
    id_variant: [],
    PVS1: [],
    PS1: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          PM5: PM5 ?? null,
          PM6: PM6 ?? null,
          PP1_Moderate: PP1_Moderate ?? null,
          PP1_Cosegregation: PP1_Cosegregation ?? null,
          PP2: PP2 ?? null,
          PP3: PP3 ?? null,
          PP4: PP4 ?? null,
          PP5: PP5 ?? null,
        ...
        try {
          ...
          await client.graphql({
            query: updateAcmgAnnotation.replaceAll("__typename", ""),
            variables: {
              input: {
                id: acmgAnnotationRecord.id,
                ...modelFields,
              },
            },
          });
      ...
      {...getOverrideProps(overrides, "AcmgAnnotationUpdateForm")}
      {...rest}
    >
      <TextField
        label="Id variant"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || acmgAnnotationModelProp)}
