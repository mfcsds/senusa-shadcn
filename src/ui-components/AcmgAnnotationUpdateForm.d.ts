...
import { AcmgAnnotation } from "../API.ts";
...
export declare type AcmgAnnotationUpdateFormInputValues = {
    id_variant?: string;
    PVS1?: boolean;
    PS1?: boolean;
    PS2?: boolean;
...
export declare type AcmgAnnotationUpdateFormValidationValues = {
...
export declare type AcmgAnnotationUpdateFormOverridesProps = {
    AcmgAnnotationUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type AcmgAnnotationUpdateFormProps = React.PropsWithChildren<{
    overrides?: AcmgAnnotationUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    acmgAnnotation?: AcmgAnnotation;
    onSubmit?: (fields: AcmgAnnotationUpdateFormInputValues) => AcmgAnnotationUpdateFormInputValues;
    onSuccess?: (fields: AcmgAnnotationUpdateFormInputValues) => void;
    onError?: (fields: AcmgAnnotationUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: AcmgAnnotationUpdateFormInputValues) => AcmgAnnotationUpdateFormInputValues;
    onValidate?: AcmgAnnotationUpdateFormValidationValues;
} & React.CSSProperties>;
export default function AcmgAnnotationUpdateForm(props: AcmgAnnotationUpdateFormProps): React.ReactElement;
