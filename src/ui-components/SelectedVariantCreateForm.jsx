...
import { createSelectedVariant } from "../graphql/mutations";
const client = generateClient();
export default function SelectedVariantCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setReviewer_class(initialValues.reviewer_class);
    setClinical_sign(initialValues.clinical_sign);
    setHgvs(initialValues.hgvs);
    setSevere_consequence(initialValues.severe_consequence);
    setSift_score(initialValues.sift_score);
    ...
    setInheritance(initialValues.inheritance);
    setErrors({});
  };
  const validations = {
    id_patient: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createSelectedVariant.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "SelectedVariantCreateForm")}
      {...rest}
    >
      <TextField
        label="Id patient"
