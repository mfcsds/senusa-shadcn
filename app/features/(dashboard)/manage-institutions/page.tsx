  ...
  return (
    <div className="p-8 min-h-screen">
      ...
      {loading ? (
              ...
              <p className="text-lg text-center mt-10 text-primary font-semibold">No institutions found</p>
            ) : (
              <>
                {viewMode === "card" ? <CardView intialInstitution={institutions} /> : <ListView intialInstitution={institutions} />}
