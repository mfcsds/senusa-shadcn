      ...
      {data.map((item) => (
        <Card key={item.reportId}>
          <CardHeader className="flex items-left gap-4">
            <div>
              <CardTitle className="text-sm text-text-primary"> ID: {item.reportId}</CardTitle>
              <CardTitle className="text-sm text-text-primary">Patient ID: {item.patientId}</CardTitle>
            </div>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-text-secondary mb-4">
              <strong>Patient Phenotypes:</strong> {item.phenotypes}
            </p>
            ...
            <div className="flex justify-between gap-2 border-t pt-2">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-sm text-text-secondary">{item.medicalHistory}</p>
              </div>
              <div className="flex flex-col gap-2">
                <p className="text-xs text-text-secondary">Current Diagnosis</p>
                <p className="text-sm text-text-secondary">{item.currentDiagnosis}</p>
              </div>
              <div className="flex flex-col gap-2">
                <p className="text-xs text-text-secondary">Sample Collection</p>
                <p className="text-sm text-text-secondary">{item.sampleCollection}</p>
              </div>
            </div>
          </CardContent>
        </Card>
