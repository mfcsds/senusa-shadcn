...
const ButtonAddPatientDisease: React.FC<PatientProops> = ({ patient_id }) => {
  ...
  useEffect(() => {
    const loadInitialData = async () => {
      try {
        ...
        const initialData = result.data.listPatientHistoryDiseases
          .items as PatientDiseaseData[];
...
export default ButtonAddPatientDisease;
